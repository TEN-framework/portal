...
import { AlertTriangle, FileCheck, Hammer, UserPlus, Users } from 'lucide-react'
            ...
            <div>
              ...
              <div className="mt-4">
                <Link
                  ...
                  className="inline-flex items-center font-semibold text-yellow-800 hover:text-yellow-700 hover:underline dark:text-yellow-200 dark:hover:text-yellow-100"
                >
