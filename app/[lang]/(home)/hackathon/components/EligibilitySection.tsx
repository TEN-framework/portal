...
import { Users, UserPlus, Hammer, FileCheck, AlertTriangle } from 'lucide-react'
      ...
      <div className="container mx-auto max-w-[72rem] px-6">
        ...
        <div className="mb-12 grid gap-8 md:grid-cols-2">
          {eligibility.map((rule, index) => (
            ...
            >
              <div className={`mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg ${rule.color} bg-current/10`}>
