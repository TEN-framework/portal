    ...
    <section className={cn("bg-white py-16 dark:bg-gray-950", className)}>
      <div className="container mx-auto max-w-[72rem] px-6">
        ...
        >
          ...
          <div className="mx-auto mb-8 max-w-3xl text-lg text-gray-700 dark:text-gray-300">
          ...
          <div className="flex justify-center">
            <Button size="lg" className="gap-2 bg-black text-white hover:bg-gray-900 dark:bg-white dark:text-black" asChild>
              <a href="https://discord.gg/8AJkU7cU" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
