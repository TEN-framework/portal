          ...
          {examples.map((example, index) => (
            ...
            >
              <div className="">
                <div
                  className={
                    'mb-6 inline-flex h-16 w-16 items-center justify-center rounded-full border border-gray-200 bg-black text-white dark:border-gray-700 dark:bg-white dark:text-black'
                  }
                >
                  {example.icon}
                </div>
