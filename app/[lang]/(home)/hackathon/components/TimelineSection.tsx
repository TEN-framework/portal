					...
					<div className="space-y-12">
						{timeline.map((item, index) => (
							...
							>
								{/* Content Card */}
								<div
									className={`w-full md:w-5/12 ${index % 2 === 0 ? "md:text-right md:pr-8" : "md:text-left md:pl-8"} text-center`}
								>
								...
								<div className="relative mx-0 my-4 md:my-0">
									<div
										className={`flex h-12 w-12 items-center justify-center rounded-full bg-black text-white dark:bg-white dark:text-black border border-gray-200 dark:border-gray-700`}
									>
										{item.icon}
									</div>
