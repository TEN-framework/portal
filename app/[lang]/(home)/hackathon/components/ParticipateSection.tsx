      ...
      <div className="container mx-auto max-w-[72rem] px-6">
        ...
        <div className="mb-16 grid gap-8 md:grid-cols-3">
          {steps.map((step, index) => (
            ...
            >
              <div className=" mb-6">
                <div className={`mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-black text-white dark:bg-white dark:text-black border border-gray-200 dark:border-gray-700`}>
                  {step.icon}
                </div>
