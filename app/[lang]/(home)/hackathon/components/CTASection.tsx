...
export function CTASection({ className }: { className?: string }) {
  ...
  return (
    <section className={cn('py-16 bg-gray-900 dark:bg-gray-100', className)}>
      <div className="container mx-auto max-w-[72rem] px-6">
        ...
        >
          ...
          >
            ...
            >
              <Button 
                size="lg" 
                className="gap-3 bg-white text-gray-900 hover:bg-gray-100 dark:bg-gray-900 dark:text-white dark:hover:bg-gray-800 px-8 py-4 text-lg font-medium"
              >
                {t('cta.register')}
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-16 grid gap-8 text-center text-white dark:text-gray-900 md:grid-cols-3"
        >
          <div>
            <div className="mb-2 text-3xl font-bold">$11,000</div>
            <div className="text-lg opacity-80">Total Prize Pool</div>
          </div>
          <div>
            <div className="mb-2 text-3xl font-bold">15 Days</div>
            <div className="text-lg opacity-80">Build Duration</div>
          </div>
          <div>
            <div className="mb-2 text-3xl font-bold">Global</div>
