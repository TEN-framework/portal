...
import { URL_TEN_AGENT, HUGGING_FACE_SPACE, URL_TEN_VAD, URL_TEN_TURN_DETECTION } from '@/constants'
          ...
          <div>
            ...
            >
              <span className="flex items-center gap-2">
                🎉{' '}
                <Link href={URL_TEN_VAD} className="font-medium text-blue-500 dark:text-blue-300 text-sm sm:text-base hover:underline underline-offset-2">
                  TEN VAD
                </Link>
                <span className="font-medium text-blue-500 dark:text-blue-300 text-sm sm:text-base">
                  and
                </span>
                <Link href={URL_TEN_TURN_DETECTION} className="font-medium text-blue-500 dark:text-blue-300 text-sm sm:text-base hover:underline underline-offset-2">
                  TEN Turn Detection
                </Link>
                <span className="font-medium text-blue-500 dark:text-blue-300 text-sm sm:text-base">
