    ...
    <div className='relative min-h-screen overflow-hidden bg-black text-white'>
      ...
      <section className='relative z-10 mx-auto flex min-h-[90vh] max-w-6xl flex-col items-center justify-center gap-10 px-6 py-24 text-center'>
        <div className='flex flex-col items-center gap-5'>
          <span className='inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1 text-sm text-white/80 uppercase tracking-[0.3em]'>
            {lang === 'cn'
            ...
            <div className='relative flex flex-col items-center gap-3 text-center'>
              ...
              <div className='relative flex flex-col items-center gap-3 text-center md:gap-5 lg:gap-1'>
                ...
                <span
                  className={cn(
                    orbitron.className,
                    'font-semibold text-[clamp(2.3rem,6.3vw,3.8rem)] text-amber-50/80 uppercase tracking-[0.45em] lg:text-[clamp(2.5rem,6vw,4rem)]'
                  )}
                >
                ...
                <span
                  className={cn(
                    orbitron.className,
                    'text-amber-50/60 text-sm uppercase tracking-[0.45em]'
                  )}
                >
                  {milestoneLabel}
                </span>
