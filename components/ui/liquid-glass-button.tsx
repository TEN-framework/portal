  ...
  'inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium text-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        cool: 'border border-zinc-950/40 border-b-2 bg-linear-to-t from-primary to-primary/85 text-primary-foreground shadow-md shadow-primary/20 ring-1 ring-white/25 ring-inset transition-[filter] duration-200 hover:brightness-110 active:brightness-90 dark:inset-shadow-2xs dark:inset-shadow-white/10 dark:border-primary/50 dark:border-x-0 dark:border-t-0 dark:text-primary-foreground dark:ring-white/5',
        outline:
...
function GlassFilter() {
  return (
    <svg className='hidden'>
      <title className='sr-only'>Glass Filter</title>
      <defs>
        <filter
          id='container-glass'
          x='0%'
...
const metalButtonVariants = (
  ...
  return {
    ...
    button: cn(
      'relative z-10 m-[1px] inline-flex h-11 transform-gpu cursor-pointer items-center justify-center overflow-hidden rounded-md rounded-md px-6 py-2 font-semibold text-sm leading-none outline-none will-change-transform',
      colors.button,
      colors.textColor,
      colors.textShadow
    ),
  ...
  ({ children, className, variant = 'default', ...props }, ref) => {
    ...
    return (
      <div
        ...
        style={variants.wrapperStyle as React.CSSProperties}
      >
        <div
          className={variants.inner}
          style={variants.innerStyle as React.CSSProperties}
        ></div>
        <button
          ref={ref}
          className={cn(variants.button, className)}
          style={variants.buttonStyle as React.CSSProperties}
          {...props}
