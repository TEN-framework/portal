...
export function GitHubStarButton({
  ...
  return (
    ...
    >
      ...
      <span className="dark:text-gray-300">open source</span>
      <Star className="h-4 w-4 fill-transparent stroke-white text-white transition-colors group-hover:stroke-[#FFD700] group-hover:text-[#FFD700]" />
