  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className={`group relative inline-flex items-center gap-2 rounded-md bg-gradient-to-r from-gray-900 to-black px-3 py-1.5 text-sm font-medium text-white transition-all duration-300 hover:from-gray-800 hover:to-gray-900 hover:scale-105 ${className}`}
      >
        {/* GitHub icon */}
        ...
        <Star className={`h-4 w-4 relative z-10 transition-all duration-300 ${isHovered ? 'fill-yellow-400 stroke-yellow-400 scale-110' : 'fill-transparent stroke-white'}`} />
        <span className={`inline-block w-16 rounded bg-gradient-to-r from-gray-700 to-gray-600 px-2 py-0.5 text-center text-xs font-bold relative z-10 transition-all duration-300 ${isHovered ? 'from-orange-600 to-yellow-600 text-white scale-105' : ''}`}>
