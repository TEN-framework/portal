...
export function WorkshopHero({ workshop }: { workshop: Workshop }) {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <div className="absolute -bottom-32 -right-6 size-[520px] rounded-full bg-emerald-400/10 blur-3xl" />

      <div className="relative mx-auto flex w-full max-w-[1100px] flex-col gap-12 px-6 py-20 lg:flex-row lg:py-24">
        <div className="flex-1 space-y-6">
          <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-black/20 px-4 py-2 text-sm font-medium text-white/80 backdrop-blur">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            <Button
              ...
              asChild
            >
              <a href={workshop.registrationUrl} target="_blank" rel="noreferrer">
                {workshop.ctaLabel}
              </a>
            </Button>
