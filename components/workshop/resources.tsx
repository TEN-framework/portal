...
const ResourceCard = ({ resource }: { resource: WorkshopResource }) => {
  ...
  return (
    ...
    >
      <div className='flex items-start justify-between gap-4'>
        ...
        <span
          className={cn(
            'inline-flex items-center gap-1 rounded-full px-3 py-1 font-semibold text-xs uppercase tracking-wide',
            isLocked
      ...
      <a
        ...
        className={cn(
          'mt-4 inline-flex items-center gap-2 font-medium text-sm',
          isLocked
            ? 'text-slate-400'
    ...
    <section className='py-16'>
      <div className='mx-auto grid w-full max-w-5xl gap-12 px-6 lg:grid-cols-[1.1fr_minmax(0,1fr)]'>
        ...
        <div className='space-y-8'>
          <div>
            <p className='mb-4 text-slate-500 text-xs uppercase tracking-wide dark:text-slate-400'>
              Before the session
            </p>
