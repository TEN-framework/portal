...
Save the file, then Choose "App->Reload All Apps" to reload extension settings. Note this is mandatory when you want changes in manifest.json to take effect after you change the file without TMAN Designer.
