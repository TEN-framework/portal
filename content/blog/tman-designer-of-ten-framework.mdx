...
![](../../public/assets/blog/tman-designer/tman-1.webp)
<div style={{ textAlign: 'center', fontSize: '0.9em' }}>
TEN Designer Overview
</div>
...
```
https://github.com/TEN-framework/ten_framework/releases/tag/0.9.0
```
...
- The first button on the left is the TEN Agent button. Clicking it will open the TEN Agent page. TEN Agent is a complete AI Agent implementation built using TEN Framework. One of the main goals of TEN Designer is to enable developers to easily develop, debug, and customize TEN Agent through TEN Designer.
...
![](../../public/assets/blog/tman-designer/tman-3.webp)
<div style={{ textAlign: 'center', fontSize: '0.9em' }}>
Loading an Existing TEN App
</div>
...
![](../../public/assets/blog/tman-designer/tman-4.webp)
<div style={{ textAlign: 'center', fontSize: '0.9em' }}>
Managing Loaded TEN Apps
</div>
...
![](../../public/assets/blog/tman-designer/tman-5.webp)
<div style={{ textAlign: 'center', fontSize: '0.9em' }}>
Installing All Dependencies for an App
</div>
...
![](../../public/assets/blog/tman-designer/tman-6.webp)
<div style={{ textAlign: 'center', fontSize: '0.9em' }}>
TEN Cloud Store
</div>
...
![](../../public/assets/blog/tman-designer/tman-7.webp)
<div style={{ textAlign: 'center', fontSize: '0.9em' }}>  
Running a TEN App
</div>
...
![](../../public/assets/blog/tman-designer/tman-8.webp)
<div style={{ textAlign: 'center', fontSize: '0.9em' }}>
Building a TEN App
</div>
...
![](../../public/assets/blog/tman-designer/tman-9.webp)
<div style={{ textAlign: 'center', fontSize: '0.9em' }}>
Starting a TEN App
</div>
...
![TEN Graph](../../public/assets/blog/tman-designer/tman-10.webp)
<div style={{ textAlign: 'center', fontSize: '0.9em' }}>
...
![TEN Message Input/Output Dialog](../../public/assets/blog/tman-designer/tman-11.webp)
<div style={{ textAlign: 'center', fontSize: '0.9em' }}>
...
![Context menu showing options for TEN Extension configuration](../../public/assets/blog/tman-designer/tman-12.webp)
...
![](../../public/assets/blog/tman-designer/tman-13.webp)
