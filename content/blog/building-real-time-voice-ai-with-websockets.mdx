...
description: Learn how to build production-ready voice AI applications using WebSockets instead of WebRTC. Explore TEN Framework's simple yet powerful JSON-based protocol for real-time STT → LLM → TTS pipelines.
author: Elliot Chen
date: 2025-11-11
featured: true
...
👉 Explore the [**WebSocket Example**](https://github.com/TEN-framework/TEN-framework/tree/main/ai_agents/agents/examples/websocket-example)

💬 Join our [**Discord Community**](https://discord.gg/VnPftUzAMJ) to share what you're building
