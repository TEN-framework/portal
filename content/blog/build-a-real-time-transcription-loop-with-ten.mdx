...
The example ships lean yet battle-tested: a low-latency runtime graph, a Python control extension that polishes text on the fly, and a browser client that stays vendor-neutral. Fork it for live captions, meeting notes, or any use-case where the transcript should lag speech by a blink.
