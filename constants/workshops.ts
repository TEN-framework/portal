...
export const workshopSpeakers: Record<string, WorkshopSpeaker> = {
  elliotChen: {
    ...
    avatar: 'https://avatar.vercel.sh/elliot-chen?background=1e293b&color=38bdf8',
    pronouns: 'he/him',
    social: [
      {
        type: 'linkedin',
  ...
  devinPark: {
    ...
    avatar: 'https://avatar.vercel.sh/devin-park?background=0f172a&color=22d3ee',
    pronouns: 'they/them',
    social: [
      {
        type: 'github',
...
export const workshops: Workshop[] = [
  {
    ...
    headline: 'Wire Speechmatics diarization into TEN and ship a speaker-labelled voice agent in 90 minutes.',
    description:
    ...
    prerequisites: [
      {
        ...
        description: 'Follow the quickstart to set up the TEN Agent runtime locally.',
      ...
      },
      {
        ...
        description: 'Create a Speechmatics account and generate a diarization-enabled key.',
      ...
      },
      {
        ...
        description: 'Provision an Agora project and grab the App ID for audio streaming.',
    ...
    resources: [
      {
        ...
        description: 'PDF of the architecture deck used during the walkthrough.',
        url: '#',
        status: 'locked',
        kind: 'post',
      },
      ...
      },
      {
        ...
        description: 'On-demand replay arrives 48 hours after the live session.',
        url: '#',
        status: 'locked',
        kind: 'post',
      },
